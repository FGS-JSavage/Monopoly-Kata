    ...
    public class Realtor
    {
        ...
        public Realtor()
        {
            ...
            propertyList = new Dictionary<int, ILocation>()
            {
                ...
                { 30, new Location(         30,          PropertyGroup.Jail        )}, // NOT RENTABLE
        ...
        {
            return propertyList[spaceNumber].GetType() == typeof(IRentableLocation) &&
                   !ownersBySpaceNumber.ContainsKey(spaceNumber);
        }

        public int GetPriceOfSpace(int spaceNumber)
        {
            return ((IRentableLocation) propertyList[spaceNumber]).Price;
        }
